...
public class ViewClearEditText extends AppCompatEditText {
    ...
    private IViewCall IViewCall; //单纯的点击清除事件回调
    ...
    private void init() {
        ...
        if (drawableClear == null) {
            drawableClear = ContextCompat.getDrawable(getContext(), R.drawable.ico_root_clear);
        }
        if(drawableClear==null){
            return;
        }
...
//        //设置焦点改变监听
    ...
    public void setClearListener(IViewCall IViewCall) {
        this.IViewCall = IViewCall;
    }
