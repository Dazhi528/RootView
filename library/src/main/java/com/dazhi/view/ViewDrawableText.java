 ...
 * 传入dp值
 */
public class ViewDrawableText extends AppCompatTextView {
     ...
     * 描述：
     *=======================================*/
    public ViewDrawableText(Context context){
        this(context, null);
    }
    public ViewDrawableText(Context context, AttributeSet attrs){
        super(context, attrs);
