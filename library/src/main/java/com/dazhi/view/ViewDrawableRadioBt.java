...
public class ViewDrawableRadioBt extends AppCompatRadioButton {
    ...
    /**=======================================
     * 作者：WangZezhi  (2018/7/5  11:09)
     * 功能：构造方法
     * 描述：
     *=======================================*/
    public ViewDrawableRadioBt(Context context) {
        this(context, null);
    }
    public ViewDrawableRadioBt(Context context, AttributeSet attrs) {
        super(context, attrs);
